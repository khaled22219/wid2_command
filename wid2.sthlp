{smcl}
{* *! version 1.0.0 Date: 20-02-2025 *}
{hline}
help for {hi:wid2 } {right:A Module for Bulk Data Download from the WID Database}
{hline}

{title:Title }

{p 4 4 2}
{bf:wid2 } - Download and unzip data from the World Inequality Database (WID)

{title:Syntax }

{p 8 8 2}
{cmd:wid2 } [, {cmdab:savepath }({it:string })]
...
{p 8 8 2}
{cmd:. wid2, savepath("C:/path/to/your/directory")}
